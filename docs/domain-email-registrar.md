...
![WHOIS capture of atlantis-software.net (Namecheap, created 2026-05-07)](../assets/images/atlantis-whois.png)
...
![Six-message mailbox thread with a.tiertant@atlantis-software.net](../assets/images/mailbox-thread-excerpt.png)
...
![Final-reply message header: SPF PASS, DKIM PASS, DMARC FAIL](../assets/images/authenticated-mail-header.png)
...
![Preservation request to Namecheap for atlantis-software.net (19 May 2026)](../assets/images/preservation-request-evidence.png)
